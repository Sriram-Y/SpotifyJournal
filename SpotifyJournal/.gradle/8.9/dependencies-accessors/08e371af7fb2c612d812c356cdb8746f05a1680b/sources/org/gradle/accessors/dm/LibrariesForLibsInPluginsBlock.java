...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Group of libraries at <b>tiles</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    /**
     * Group of libraries at <b>watchface</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    ...
    public static class TilesLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final TilesToolingLibraryAccessors laccForTilesToolingLibraryAccessors = new TilesToolingLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>tiles.tooling</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TilesToolingLibraryAccessors getTooling() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTilesToolingLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TilesToolingLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public TilesToolingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>tooling</b> with <b>androidx.wear.tiles:tiles-tooling</b> coordinates and
         * with version reference <b>tilesTooling</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getPreview() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tiles.tooling.preview");
        }
    ...
    public static class WatchfaceLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>watchface.complications</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class WatchfaceComplicationsLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>watchface.complications.data</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class WatchfaceComplicationsDataLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>watchface.complications.data.source</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>horologistComposeTools</b> with value <b>0.6.17</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>horologistTiles</b> with value <b>0.6.17</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tiles</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tilesMaterial</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tilesTooling</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTilesTooling() { return getVersion("tilesTooling"); }

        /**
         * Version alias <b>tilesToolingPreview</b> with value <b>1.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTilesToolingPreview() { return getVersion("tilesToolingPreview"); }
